...
class Idle:
    ...
    def enter(boy, e):
        ...
        boy.bb = boy.x - 20, boy.y - 50, boy.x + 20, boy.y + 50
...
class Sleep:
    ...
    def enter(boy, e):
        ...
        boy.frame = 0
        if boy.face_dir == 1:
            boy.bb = boy.x - 80, boy.y - 40, boy.x+20, boy.y
        else:
            boy.bb = boy.x -20, boy.y - 40, boy.x + 80, boy.y
...
class Run:
    ...
    def enter(boy, e):
        ...
        boy.bb = boy.x - 30, boy.y - 50, boy.x + 30, boy.y + 50
...
class Boy:
    ...
    def __init__(self):
        ...
        self.bb=self.x - 20, self.y - 50, self.x + 20, self.y + 50
    ...
    def draw(self):
        ...
        draw_rectangle(*self.get_bb()) # 네 개의 값으로 된 한 개의 튜풀
